                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="regional" class="collapse">
                            <li>
                                <a href="#" id="menu_riga">Rīga</a>
                            </li>
                            <li>
                                <a href="#" id="menu_vidzeme">Vidzemes reģions</a>
                            </li>
                            <li>
                                <a href="#" id="menu_kurzeme">Kurzemes reģions</a>
                            </li>
                            <li>
                                <a href="#" id="menu_zemgale">Zemgales reģions</a>
                            </li>
                            <li>
                                <a href="#" id="menu_latgale">Latgales reģions</a>
                            </li>
                        </ul>
                    </li>
                    <li>
