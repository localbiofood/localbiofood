...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div id="map" style="display:block;width:100%; height:450px"></div>
            </div>

            <div class="col-md-6">
                <form action="{{route('timetable::post')}}" method="POST" class="">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="form-group @if ($errors->has('region')) has-error @endif">
                            ...
                            <div class="col-md-10">
                                <select name="region" class="form-control" id="region">
                                    <option value="Riga">Rīga un tās apkārtne</option>
                    ...
                    <div class="row">
                        <div class="form-group @if ($errors->has('Address')) has-error @endif">
                            ...
                            <div class="col-md-10">
                                <div id="address">
                                    <textarea name="" id="" class="form-control" cols="30" rows="3">Test</textarea>
                                </div>
                                @if ($errors->has('Address'))
                                    <span class="help-block">{{ $errors->first('Address')}}</span>
                                @endif
